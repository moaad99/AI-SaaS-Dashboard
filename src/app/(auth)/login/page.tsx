...
import { Sparkles, Github, ArrowRight, Eye, EyeOff } from "lucide-react";
    ...
    <>
      <div className="hidden lg:flex flex-1 relative bg-gradient-to-br from-violet-600 to-indigo-700 items-center justify-center p-12">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="relative text-white max-w-md">
          ...
          <h1 className="text-3xl font-bold mb-4">Welcome back to NeuralArc</h1>
          <p className="text-white/70 leading-relaxed">
            Access your AI-powered workspace, manage prompts, and collaborate with your team from one powerful dashboard.
          </p>
        </motion.div>
      </div>
